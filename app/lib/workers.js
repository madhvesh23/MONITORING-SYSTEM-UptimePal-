...
// Timer to execute the worker-rotate logs once per day
...
workers.init = function () {
    ...
    workers.rotateLogs();
    // call the loop so the logs will compressed later on
